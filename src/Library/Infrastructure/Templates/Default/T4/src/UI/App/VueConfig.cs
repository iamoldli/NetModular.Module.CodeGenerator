...
module.exports = {
  ...
  devServer: {
    port: ");
            ...
            #line default
            #line hidden
            this.Write("-lib-skins/publicĿ¼�µ��ļ������Ŀ¼\r\n       */\r\n      new CopyWebpackPlugin([\r\n        {" +
  ...
  chainWebpack: config => {
    /**
     * ɾ��������ģ��� prefetch preload�����ʹ���ѹ��
     * https://cli.vuejs.org/zh/guide/html-and-static-assets.html#prefetch
     * https://cli.vuejs.org/zh/guide/html-and-static-assets.html#preload
     * ����Ԥ��Ⱦʱ���ɵ� prefetch ��ǩ�� modern �汾�ģ��Ͱ汾������ǲ���Ҫ��
     */
     ...
     * ����index.htmlģ��·����ʹ��");
            ...
            #line default
            #line hidden
            this.Write("-lib-skins/public�е�ģ��\r\n     */\r\n    config.plugin(\'html\').tap(args => {\r\n      ar" +
      ...
      .when(!isDev, config => {
        config.optimization.minimizer([
          new UglifyJsPlugin({
            uglifyOptions: {
              // �Ƴ� console
              // �����Ż�ѡ�� https://segmentfault.com/a/1190000010874406
              warnings: false,
              compress: {
                drop_console: true,
                drop_debugger: true,
