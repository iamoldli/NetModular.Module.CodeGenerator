...
namespace NetModular.Module.CodeGenerator.Infrastructure.Templates.Default.T4.build
{
    ...
    #line 1 "D:\MyProject\NetModular\src\Module\CodeGenerator\Library\Infrastructure\Templates\Default\T4\build\ModuleBuildTargets.tt"
...
#line hidden
  ...
  <Target Name=""ModulesBuildBefore"" AfterTargets=""Build"">
    ...
    <!--����module.json�ļ���Note����Ŀ��Ҫ�������Σ�����Nuget���е��ļ��������µ�-->
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
    public class ModuleBuildTargetsBase
    {
        #region Fields
